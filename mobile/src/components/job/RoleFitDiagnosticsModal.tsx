...
const styles = StyleSheet.create({
  ...
  roleTitle: { fontSize: Typography.xs, fontWeight: '700', letterSpacing: 0.8 },
  roleName: { fontSize: Typography.base, fontWeight: '700', marginTop: 2 },
  scoreBadge: { paddingHorizontal: Spacing.md, paddingVertical: Spacing.xs, borderRadius: Radius.lg, alignItems: 'center' },
  scoreValue: { fontSize: Typography.xl, fontWeight: '800' },
  scoreLabel: { fontSize: 10, fontWeight: '800', letterSpacing: 0.5 },
  verdictBox: { flexDirection: 'row', gap: 8, padding: Spacing.sm, borderRadius: Radius.md, borderWidth: 1 },
  verdictText: { flex: 1, fontSize: Typography.xs, lineHeight: 18 },
  ...
  fitBarLabel: { fontSize: Typography.xs, fontWeight: '600' },
  fitBarPct: { fontSize: Typography.xs, fontWeight: '700' },
  ...
  listText: { flex: 1, fontSize: Typography.xs, lineHeight: 18 },
});
