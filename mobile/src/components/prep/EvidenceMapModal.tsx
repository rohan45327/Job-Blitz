...
const styles = StyleSheet.create({
  ...
  roleTitle: { fontSize: Typography.fontSize.xs, fontWeight: Typography.fontWeight.medium, textTransform: 'uppercase', letterSpacing: 0.5 },
  coverageLabel: { fontSize: Typography.fontSize.md, fontWeight: Typography.fontWeight.bold, marginTop: 2 },
  coverageBadge: { paddingHorizontal: Spacing.md, paddingVertical: Spacing.xs, borderRadius: Radius.full },
  coverageValue: { fontSize: Typography.fontSize.lg, fontWeight: Typography.fontWeight.bold },
  takeawayBox: { flexDirection: 'row', gap: 8, padding: Spacing.sm, borderRadius: Radius.md, borderWidth: 1 },
  takeawayText: { flex: 1, fontSize: Typography.fontSize.xs, lineHeight: 18 },
  ...
  projectTitle: { fontSize: Typography.fontSize.base, fontWeight: Typography.fontWeight.bold, flex: 1, paddingRight: Spacing.sm },
  strengthTag: { paddingHorizontal: Spacing.sm, paddingVertical: 2, borderRadius: Radius.sm, borderWidth: 1 },
  strengthText: { fontSize: Typography.fontSize.xs, fontWeight: Typography.fontWeight.bold },
  chipSection: { marginTop: 2 },
  chipLabel: { fontSize: Typography.fontSize.xs, fontWeight: Typography.fontWeight.semibold, marginBottom: 4 },
  ...
  tpText: { flex: 1, fontSize: Typography.fontSize.xs, lineHeight: 18 },
  unmappedCard: { padding: Spacing.md, borderRadius: Radius.md, borderWidth: 1, marginBottom: Spacing.sm },
  unmappedReq: { fontSize: Typography.fontSize.sm, fontWeight: Typography.fontWeight.semibold, flex: 1 },
  unmappedSugg: { fontSize: Typography.fontSize.xs, lineHeight: 18, marginTop: 2 },
});
