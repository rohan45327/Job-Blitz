...
const styles = StyleSheet.create({
  ...
  funnelText: { fontSize: Typography.sm, fontWeight: '600', flex: 1, flexWrap: 'wrap', lineHeight: Typography.sm * 1.4 },
  valueCard: { flexDirection: 'row', alignItems: 'center', gap: 10, padding: Spacing.md, borderRadius: Radius.lg, borderWidth: 1 },
  valueText: { fontSize: Typography.sm, flex: 1, flexWrap: 'wrap', lineHeight: Typography.sm * 1.45 },
  benchRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 4 },
  benchLabel: { fontSize: Typography.sm },
  benchValue: { fontSize: Typography.sm, fontWeight: '700', flexShrink: 1 },
